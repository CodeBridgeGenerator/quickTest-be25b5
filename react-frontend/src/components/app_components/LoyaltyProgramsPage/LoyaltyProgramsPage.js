    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                ...
                setLoading(false);
                props.hide();
                props.alert({ title: "Loyalty Programs", type: "error", message: error.message || "Failed get Loyalty Programs" });
            });
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Loyalty Programs", type: "error", message: error.message || "Failed delete record" });
        }
    };
