...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <MultiSelect id="products" value={_entity?.products?.map((i) =>i._id)} options={productsOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("products", e.value)}  />
            </span>
            <small className="p-error">
