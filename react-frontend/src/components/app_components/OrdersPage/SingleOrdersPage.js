  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            ? res.products.map((elem) => ({ _id: elem._id, name: elem.name }))
            : res.products
                ? [{ _id: res.products._id, name: res.products.name }]
                : [];
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Products</label>
                    {products.map((elem) => (
